...
| scp.image.tag | string | `"2.6.6"` |  |
| scp.mongodb.enabled | bool | `false` |  |
| sgwc.enabled | bool | `true` |  |
| sgwc.image.tag | string | `"2.6.6"` |  |
| sgwu.enabled | bool | `true` |  |
| sgwu.image.tag | string | `"2.6.6"` |  |
| smf.enabled | bool | `true` |  |
| smf.image.tag | string | `"2.6.6"` |  |
| udm.enabled | bool | `true` |  |
| udm.image.tag | string | `"2.6.6"` |  |
| udr.enabled | bool | `true` |  |
| udr.image.tag | string | `"2.6.6"` |  |
| udr.mongodb.enabled | bool | `false` |  |
| upf.enabled | bool | `true` |  |
| upf.image.tag | string | `"2.6.6"` |  |
| webui.enabled | bool | `true` |  |
| webui.image.tag | string | `"2.6.6"` |  |
