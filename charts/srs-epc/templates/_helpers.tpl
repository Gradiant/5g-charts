{{- /*
name defines a template for the name of the srsepc chart.
...
Usage: 'name: "{{- template "srsepc.name" . -}}"'
*/ -}}
{{- define "srsepc.name"}}
...
the release name and the srsepc chart name.
...
Usage: 'name: "{{- template "srsepc.fullname" . -}}"'
*/ -}}
{{- define "srsepc.fullname"}}
{{- $global := default (dict) .Values.global -}}
...
{{- /*
srsepc.labels.standard prints the standard srsepc Helm labels.
The standard labels are frequently used in metadata.
*/ -}}
{{- define "srsepc.labels.standard" -}}
app.kubernetes.io/name: {{ template "srsepc.name" . }}
helm.sh/chart: {{ template "srsepc.chartref" . }}
...
{{- /*
srsepc.chartref prints a chart name and version.
It does minimal escaping for use in Kubernetes labels.
Example output:
srsepc-0.4.5
*/ -}}
{{- define "srsepc.chartref" -}}
...
*/}}
{{- define "srsepc.imagePullSecrets" -}}
{{/*
Helm 2.11 supports the assignment of a value to a variable defined in a different scope,
