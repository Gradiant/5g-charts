{{- /*
name defines a template for the name of the srsenb chart.
...
Usage: 'name: "{{- template "srsenb.name" . -}}"'
*/ -}}
{{- define "srsenb.name"}}
...
the release name and the srsenb chart name.
...
Usage: 'name: "{{- template "srsenb.fullname" . -}}"'
*/ -}}
{{- define "srsenb.fullname"}}
{{- $global := default (dict) .Values.global -}}
...
{{- /*
srsenb.labels.standard prints the standard srsenb Helm labels.
The standard labels are frequently used in metadata.
*/ -}}
{{- define "srsenb.labels.standard" -}}
app.kubernetes.io/name: {{ template "srsenb.name" . }}
helm.sh/chart: {{ template "srsenb.chartref" . }}
...
{{- /*
srsenb.chartref prints a chart name and version.
It does minimal escaping for use in Kubernetes labels.
Example output:
srsenb-0.4.5
*/ -}}
{{- define "srsenb.chartref" -}}
...
*/}}
{{- define "srsenb.imagePullSecrets" -}}
{{/*
Helm 2.11 supports the assignment of a value to a variable defined in a different scope,
