...
```
helm install open5gs oci://registry-1.docker.io/gradiant/open5gs --version 2.2.8 --values https://gradiant.github.io/5g-charts/docs/open5gs-ueransim-gnb/5gSA-values.yaml 
```
